...
public class Controller {
    ...
    public <PdfFont> void print()throws Exception{
        ...
        header.addCell(getCell(new Paragraph("Listado de Cajeros").setFont((com.itextpdf.kernel.font.PdfFont) font).setBold().setFontSize(20f), TextAlignment.CENTER,false));
        document.add(header);
